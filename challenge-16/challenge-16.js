(function(){
	...
	*/
	...
	var fullName = 'everaldo-fonseca-moreira-branch-master';
	...
	*/
	console.log( '\nMeus amigos:' );
	var amigos = ['Alberto', 'Fiorenza', 'Lucas', 'Moises', 'Catarine'];
	var todosAmigos = amigos.reduce(function(acumulado, atual, index){
