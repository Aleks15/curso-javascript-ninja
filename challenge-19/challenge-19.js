(function(){
	...
	*/
	...
	function hasClass(markup, cssClass){
		var findClass = new RegExp('class=[\"\'](?:[\w\s]+)?'+cssClass,'gm');
	...
	/*
	issue no gitHub para essa expressão:
	var findClass = new RegExp('class=[\"\'](?:[\w\s]+)?'+cssClass,'gm');
	retornos obtidos no console apesar de dar certo no regex101:
	true para a classe container
	true para a classe text
	false para a classe date
